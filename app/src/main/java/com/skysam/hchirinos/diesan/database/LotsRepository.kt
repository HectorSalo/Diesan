 ...
 */
object LotsRepository {
    private val PATH_LOTS = when(Class.getEnviroment()) {
        Constants.DEMO -> Constants.LOTS_DEMO
        Constants.RELEASE -> Constants.LOTS
        else -> Constants.LOTS
    }
    
    private fun getInstance(): CollectionReference {
        return FirebaseFirestore.getInstance().collection(PATH_LOTS)
    }
